        ...
        findViewById(R.id.verifybtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(code.isEmpty() || code.length() < 6 ){
                    pinEntry.setError("Please Enter Correct Code...");
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            Intent i = new Intent (PhoneVerification.this, HomePage.class);
                            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(i);
                        }
                        else {
                            Toast.makeText(PhoneVerification.this, task.getException().getMessage(),
